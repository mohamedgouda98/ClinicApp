...
@section('title')
    Royal Hospitals Admin Template - Hospital
@endsection
            ...
            <div class="row gutters">
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-12">
                    <div class="hospital-tiles primary">
                        <img src="{{ asset('assetsAdmin/img/hospital/appointment.svg') }}" alt="Appointments" />
                        <p>Appointments</p>
                        <h2>49</h2>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-12">
                    <div class="hospital-tiles blue">
                        <img src="{{ asset('assetsAdmin/img/hospital/patient.svg') }}" alt="Patients" />
                        <p>New Patients</p>
                        <h2>60</h2>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-12">
                    <div class="hospital-tiles red">
                        <img src="{{ asset('assetsAdmin/img/hospital/operation.svg') }}" alt="Operations" />
                        <p>Operations</p>
                        <h2>21</h2>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-12">
                    <div class="hospital-tiles yellow">
                        <img src="{{ asset('assetsAdmin/img/hospital/doctor.svg') }}" alt="Doctors" />
                        <p>Doctors</p>
                        <h2>75</h2>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-12">
                    <div class="hospital-tiles secondary">
                        <img src="{{ asset('assetsAdmin/img/hospital/staff.svg') }}" alt="Staff" />
                        <p>Staff</p>
                        <h2>253</h2>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-12">
                    <div class="hospital-tiles green">
                        <img src="{{ asset('assetsAdmin/img/hospital/revenue.svg') }}" alt="Earnings" />
                        <p>Earnings</p>
                        <h2>$900k</h2>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="top-doctors-container">
                                <div class="top-doctor">
                                    <img src="{{ asset('assetsAdmin/img/user2.png') }}" class="avatar" alt="Agent">
                                ...
                                <div class="top-doctor">
                                    <img src="{{ asset('assetsAdmin/img/user3.png') }}" class="avatar" alt="Agent">
                                    <div class="doctor-details">
                                        <h6>Dr. Levsmia</h6>
                                        <div class="doctor-score">
                                            <div class="progress">
                                ...
                                <div class="top-doctor">
                                    <img src="{{ asset('assetsAdmin/img/user14.png') }}" class="avatar" alt="Agent">
                                    <div class="doctor-details">
